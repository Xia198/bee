...
const beesData = [
    {
        ...
        preview: '世界体型最大的蜜蜂，生活在喜马拉雅地区的高海拔悬崖上。',
        distribution: '喜马拉雅山脉地区，包括中国西南（云南、西藏）、印度北部、尼泊尔、不丹、缅甸、老挝、越南和泰国',
        habitat: '海拔2500-3000米的高山悬崖峭壁',
        features: [
            '体长可达17-20mm，是蜜蜂属中体型最大的物种',
            '工蜂体色为黑色，腹部有橙棕色斑块',
            '覆毛浓密，能适应高海拔低温环境',
            '单脾群居，蜂巢悬挂于悬崖峭壁上',
            '每巢可产蜂蜜20-40公斤'
        ],
        behavior: '黑大蜜蜂是世界上体型最大的蜜蜂品种，主要分布在喜马拉雅山区的高海拔地带。它们的蜂巢巨大，常悬挂在悬崖峭壁上，面向西南方向。每年只采蜜一次，蜂蜜产量有限但品质极高。由于生活在高海拔地区，它们具有出色的耐寒能力。',
        funFact: '黑大蜜蜂生活在海拔4100米的高山上，是唯一能在如此高海拔生存的蜜蜂物种！',
        status: '数据缺乏（DD）'
    },
    {
        id: 2,
        ...
        preview: '体型最大的蜜蜂之一，单脾群居，攻击性强，蜂巢常悬挂在树枝或岩石下。',
        distribution: '南亚、东南亚的热带和亚热带地区，包括印度、斯里兰卡、尼泊尔、孟加拉国、中国南方、东南亚各国',
        habitat: '热带雨林边缘、高山峡谷',
        features: [
            '体长可达17-20mm',
            '工蜂体色为黑色',
        ...
        behavior: '大蜜蜂采用单脾垂直悬挂的方式筑巢，蜂巢常暴露在外，可长达1米以上。攻击性强，护巢能力出众，每年会进行大规模迁飞寻找蜜源。它们是重要的野生授粉昆虫。',
    ...
    },
    {
        ...
        preview: '马来西亚婆罗洲的特有蜜蜂，也被称为"沙巴蜜蜂"，生态习性独特。',
        distribution: '马来西亚沙巴州和砂捞越、婆罗洲热带雨林',
        habitat: '原始热带雨林',
        features: [
            '体长约11-13mm',
            '体色深棕至黑色',
        ...
        behavior: '沙巴蜜蜂是婆罗洲热带雨林中的特有物种，以马来西亚沙巴州命名。它们生态习性与东方蜜蜂相似但有独特之处。由于栖息地受到砍伐和农业扩张的威胁，野生种群数量正在减少。',
    ...
    },
    {
        ...
        preview: '全球分布最广的蜜蜂种类，也是养蜂业最重要的经济蜂种。',
        distribution: '原产于欧洲、非洲和中东，现已随人类活动分布至全球各地，包括南北美洲、澳大利亚、中国、日本等',
        habitat: '温带至亚热带地区，适应各种生态环境',
        features: [
            '体长12-15mm',
            '体色变化大，从浅黄到深褐甚至黑色',
            '腹部有明显的黄色条纹',
        ...
        behavior: '西方蜜蜂是社会性昆虫的典型代表，一个蜂群可包含2-6万只个体。它们以舞蹈语言进行信息交流，能通过圆舞表示近距离蜜源，摆尾舞表示远距离蜜源。是世界上最重要的授粉昆虫和蜂蜜生产者。',
    ...
    },
    {
        ...
        preview: '又称"黑带蜜蜂"，主要分布在印度尼西亚苏拉威西岛和菲律宾群岛。',
        distribution: '印度尼西亚苏拉威西岛、菲律宾棉兰老岛和沙嗲群岛',
        habitat: '热带雨林、山地森林',
        features: [
            '体长约11-13mm，略大于东方蜜蜂',
            '体色呈深棕色至黑色',
        ...
        behavior: '绿奴蜂是东南亚热带地区的特有物种，2001年才被正式确认为独立物种。它们与东方蜜蜂亲缘关系密切，但生态位不同。绿奴蜂局限于森林环境，而东方蜜蜂则更多出现在农业区。它们对当地生态系统具有重要意义。',
        funFact: '绿奴蜂直到2001年才被确认为独立物种，此前一直被误认为东方蜜蜂！',
        status: '数据缺乏（DD）'
    },
    {
        id: 6,
        ...
        preview: '印度尼西亚苏拉威西岛的特有蜜蜂，分类地位存在一定争议。',
        ...
        behavior: '苏拉威西蜂是苏拉威西岛的特有物种，对当地植物授粉具有重要作用。值得注意的是，该物种的分类地位存在一定争议，部分学者认为它可能是沙巴蜜蜂或绿奴蜂的同义词。',
        funFact: '苏拉威西蜂的分类地位至今仍有争议，是蜜蜂学研究中的一个有趣话题！',
        status: '数据缺乏（DD）'
    },
    {
        id: 7,
        ...
        preview: '亚洲本土的蜜蜂，野性强，善于采集野生植物花蜜，具有出色的抗螨能力。',
        distribution: '东亚、南亚、东南亚，包括中国、日本、朝鲜半岛、印度、尼泊尔、东南亚各国、阿富汗、伊朗东部',
        habitat: '山地、丘陵、平原均有分布，适应多种生态环境',
        features: [
            '体长10-13mm',
            '体色以黑色为主，腹部有灰黄色绒毛带',
            '较西方蜜蜂体型小',
        ...
        behavior: '东方蜜蜂对亚洲气候和蜜源植物适应性强，是亚洲最重要的本土蜜蜂。它们抗螨能力强于西方蜜蜂，但产蜜量较低。野性较强，不易被人工饲养。能有效利用零星蜜源，是重要的野生授粉昆虫。中国已有数千年的饲养历史。',
        funFact: '东方蜜蜂是中国本土的重要授粉昆虫，已有数千年的饲养历史，比西方蜜蜂更早被人类驯养！',
        status: '无危（LC）'
    },
    {
        id: 8,
        ...
        preview: '体型较小的蜜蜂之一，蜂巢小而精致，常建于低矮植物或岩石上。',
        distribution: '南亚、东南亚的热带地区，包括印度、斯里兰卡、尼泊尔、东南亚各国',
        habitat: '热带低地、灌木丛、果园、花园',
        features: [
            '体长仅8-10mm',
            '体色鲜艳，腹部橙红色',
            '工蜂体毛较短',
        ...
        behavior: '小蜜蜂的蜂巢结构精美，巢脾水平生长，蜂王产卵区在巢脾中央。小蜜蜂性情温和，较少主动攻击人。由于体型小，它们能进入其他蜜蜂无法进入的小花采集花蜜。是重要的野生授粉昆虫。',
    ...
    },
    {
        ...
        preview: '体型最小的蜜蜂种类之一，通体呈黑色，较为罕见和神秘。',
        distribution: '东南亚的热带雨林地区，包括泰国、马来西亚、印尼、越南、老挝、缅甸、中国云南',
        habitat: '原始热带雨林、低地森林、次生林',
        features: [
            '体长仅7-8mm，是体型最小的蜜蜂之一',
            '全身呈深黑色',
            '腹部黑色，无明显黄色条纹',
        ...
        behavior: '黑小蜜蜂是最不为人知的蜜蜂种类之一，关于它们的研究较少。蜂巢小型，通常建于灌木或岩石下方。与小蜜蜂相比，它们的蜂巢位置更低。野生数量稀少，已被列为濒危物种。',
        funFact: '黑小蜜蜂直到1985年才被正式确认为独立物种，是最后被发现的蜜蜂属物种之一！',
        status: '濒危（EN）'
    }
];
        ...
        <div class="bee-card" data-bee-id="${bee.id}">
            ...
            <div class="card-image">
                <img src="${beeImages[index]}" alt="${bee.chineseName}" loading="lazy"
                     onerror="this.onerror=null; this.style.background='linear-gradient(135deg, #C4A35A 0%, #8B7355 100%)'; this.style.display='flex'; this.style.alignItems='center'; this.style.justifyContent='center'; this.outerHTML='<div style=\\'background: linear-gradient(135deg, #C4A35A 0%, #8B7355 100%); width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; font-size: 4rem; color: white;\\'>🐝</div>'">
            </div>
...
function setupModalEvents() {
    ...
    // 点击弹窗外部区域不关闭（阻止冒泡，但不影响碎花效果）
    // 移除stopPropagation，因为碎花效果在document级别监听
}
