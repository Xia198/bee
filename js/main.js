...
const beesData = [
    ...
    },
    {
        ...
        preview: '马来西亚婆罗洲的特有蜜蜂，也被称为"桑巴蜂"，生态习性独特。',
        ...
        behavior: '桑巴蜂是婆罗洲热带雨林中的特有物种，以马来西亚沙巴州命名。它们生态习性与东方蜜蜂相似但有独特之处。由于栖息地受到砍伐和农业扩张的威胁，野生种群数量正在减少。',
        funFact: '桑巴蜂是马来西亚沙巴州的骄傲，这种蜜蜂只在这片热带雨林中生活！',
        status: '易危（VU）'
    },
    {
        id: 4,
    ...
    },
    {
        ...
        behavior: '苏拉威西蜂是苏拉威西岛的特有物种，对当地植物授粉具有重要作用。值得注意的是，该物种的分类地位存在一定争议，部分学者认为它可能是桑巴蜂或绿奴蜂的同义词。',
